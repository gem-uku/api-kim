...
Die eingetragenen Werte können ausgelesen werden. In diesem Fall erzeugt der KIM-Fachdienst eine DSN, die die im Header zur KIM-Adresse gehörenden payloadType-Werte enthält.
